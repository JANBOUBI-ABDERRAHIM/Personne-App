...
for i in range(len(area)):
    ...
    if area[i] == 'Actions': widthC = 80  # Smaller width for action column
...
deleteBtn = tk.Button(root, text='Supprimer la ligne sélectionnée', command=delete_row)
deleteBtn.place(x=50, y=550)
